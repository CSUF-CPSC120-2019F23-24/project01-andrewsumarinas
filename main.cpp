...
int main()
{
  ...
  std::cout << std::setw(20) << "Location" << std::setw(8) << "Days"<<
  std::setw(12) << "Hotel" << std::setw(12) << "Meal" << std::setw(12) << "Total" <<
  std::endl;

  //and here are the corresponding data inputted by the user
  std::cout << std::setw(20) << myLocation << std::setw(8) << myDays << std::setw(12)
  << myHotelExpense << std::setw(12) << myMealExpense << std::setw(12) << myTotal;
